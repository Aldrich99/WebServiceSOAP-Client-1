 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:8585/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.com/", "BanqueServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8585/BanqueService?wsdl");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service.com/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "BanqueWSPort"), BanqueWS.class, features);
    }
